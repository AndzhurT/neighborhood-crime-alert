...
class CrimeGraphApp:
    def __init__(self, root):
        ...
        self.source_var = tk.StringVar(value='Downtown')
        self.source_dropdown = ttk.Combobox(self.root, textvariable=self.source_var, values=['Downtown', 'Uptown', 'Brooklyn', 'Queens', 'Soho', 'Chelsea', 'Times Square', 'Midtown', 'Central Park', 'Harlem', 'Bronx', 'Battery Park', 'Financial District', 'Chinatown'])
    ...
    def visualize_graph(self):
        ...
        # Find notified nodes
        notified_nodes = dijkstra_notify(graph, source_node, radius).keys()
        
        # Visualize the graph
        visualize_graph(graph, notified_nodes, source_node, radius)
